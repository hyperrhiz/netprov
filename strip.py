...
f = csv.writer(open("/Users/hjburges/Documents/sootfall.csv", "w"), delimiter = ",") #csv output file, changing '/t' changed how the file is delimited. /t is by tab.
f.writerow(["Username", "Time and Date", "Tweet Text", "URL Links", "Twitter Permalink"]) #csv column headings

soup = BeautifulSoup(open("/Users/hjburges/Documents/sootfall.html")) #input html document 
